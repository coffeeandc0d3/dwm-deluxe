...
/* appearance */
static const char col_mint_green[]  = "#49C495";
static const char col_soft_red[]    = "#BA4579";
...
#else
static const char *fonts[]               = {"monospace:size=17", "Symbols Nerd Font:size=22"};
...
static char normbgcolor[]                = "#2B2E41";
...
// Colors for titlebar of launched apps
static char titlenormfgcolor[]           = "#bbbbbb";
//static char titlenormbgcolor[]           = "#222222";
static char titlenormbgcolor[]           = "#2b2e41";
...
//Main accent color
static char titleselbgcolor[]            = "#7dc9b3";
static char titleselbordercolor[]        = "#005577";
static char titleselfloatcolor[]         = "#005577";

static char tagsnormfgcolor[]            = "#bbbbbb";
//static char tagsnormbgcolor[]            = "#222222";
static char tagsnormbgcolor[]            = "#2B2E41";
static char tagsnormbordercolor[]        = "#444444";
static char tagsnormfloatcolor[]         = "#db8fd9";

static char tagsselfgcolor[]             = "#eeeeee";
// Tag color when selected
static char tagsselbgcolor[]             = "#8CC3AF";
...
static char *colors[][ColCount] = {
	/*                       fg                bg                border                float */
	[SchemeNorm]         = { normfgcolor,      normbgcolor,      col_mint_green,      col_mint_green },
	[SchemeSel]          = { selfgcolor,       selbgcolor,       col_soft_red,       col_soft_red },
...
// Special key macros with gyms from xev
...
#if BAR_HOLDBAR_PATCH
#define HOLDKEY 0 // replace 0 with the gym to activate holdbar
#endif // BAR_HOLDBAR_PATCH
...
static Key on_empty_g[] = {
	/* modifier key            function                argument */
	{ 0,        XK_f,          spawn,                  {.v = firefoxcmd } },
};
#endif // ON_EMPTY_g_PATCH

//Rofi
static const char *roficmd[] = { "rofi", "-show", "drun", "kb-cancel", "Control_L+space",  NULL };
static const char *rangercmd[] = { "alacritty", "-e", "ranger", NULL };
static const char *rofiedit[] = { ".local/bin/rofi-edit.sh", NULL };
static const char *rofipowermenu[] = { ".local/bin/rofi-power-menu.sh", NULL };
static const char *rofibrightness[] = { "/usr/local/bin/brightnessmenu", NULL };
static const char *rofiwifimenu[] = { ".local/bin/rofi-wifi-menu.sh", NULL };
static const char *justindmenu[] = { "dmenu_run","-fn","'FiraCode-27'","-h", "27", NULL};
static const char *screenshotcopy[] = {"/home/justin/.local/bin/screenshotcopy.sh", NULL};
static const char *xsetrate[] = {"/home/justin/.local/bin/xset.sh", NULL};

//maim -u -f png | xclip -selection clipboard -t image/png && notify-send "Screenshot Saved To Clipboard"
...
//  	Screenshot active display and copies to clipboard 
	{ MODKEY|ControlMask,          XK_s,           spawn,                  {.v = screenshotcopy } },
	{ MODKEY|ControlMask,          XK_k,           spawn,                  {.v = xsetrate } },

//       Rofi and Dmenu //
//        { MODKEY,                   	XK_d,          spawn,                  {.v = dmenucmd } },
        { MODKEY|ControlMask,           XK_d,	       spawn,                  {.v = justindmenu } },
        { MODKEY,           		XK_d,	       spawn,                  {.v = justindmenu } },
//	{ ControlMask,                  XK_d,          spawn,                  {.v = roficmd } },
//	{ ControlMask,                  XK_space,      spawn,                  {.v = roficmd } },

	{ MODKEY,           		XK_Print,      spawn,                   {.v = rofibrightness } },
	{ MODKEY|ShiftMask,             XK_c,          spawn,                   {.v = rofiedit } },
	{ MODKEY|ControlMask|ShiftMask, XK_p,          spawn,                   {.v = rofipowermenu} },
	{ MODKEY|ControlMask|ShiftMask, XK_w,          spawn,                   {.v = rofiwifimenu} },

	{ ControlMask|ShiftMask,        XK_r,          spawn,                  {.v = rangercmd } },
...
//	{ MODKEY,                       XK_Up,         focusdir,               {.i = 2 } }, // up
	//{ MODKEY|Mod4Mask,              XK_comma,      focusdir,               {.i = 2 } }, // up
//
	//{ MODKEY|Mod4Mask,              XK_period,       focusdir,               {.i = 3 } }, // down
//	{ MODKEY,                       XK_Down,       focusdir,               {.i = 3 } }, // down

//  Justin vim bindings alt hjkl
	{ MODKEY,                       XK_h,       focusdir,               {.i = 0 } }, // left
	{ MODKEY,              		XK_comma,   focusdir,               {.i = 0 } }, // left
											 //
	{ MODKEY,                       XK_l,       focusdir,               {.i = 1 } }, // right
	{ MODKEY,              		XK_period,  focusdir,               {.i = 1 } }, // right
...
//	{ MODKEY,                       XK_j,       focusdir,               {.i = 3 } }, // down
	...
	#endif // PUSH_PATCH / PUSH_NO_MASTER_PATC
...
//  Resize horizontally shortcut jcs
...
// 	+Vim bindings	
	...
	#if MOVERESIZE_PATCH
	{  ControlMask|Mod4Mask,         XK_Down,       moveresize,             {.v = "0x 25y 0w 0h" } },
	{  ControlMask|Mod4Mask,         XK_Up,         moveresize,             {.v = "0x -25y 0w 0h" } },

	{  ControlMask|Mod4Mask,         XK_j,       moveresize,             {.v = "0x 25y 0w 0h" } },
	{  ControlMask|Mod4Mask,         XK_k,         moveresize,             {.v = "0x -25y 0w 0h" } },

	{  ControlMask|Mod4Mask,          XK_l,      moveresize,             {.v = "25x 0y 0w 0h" } },
	{  ControlMask|Mod4Mask,          XK_h,       moveresize,             {.v = "-25x 0y 0w 0h" } },

	{  ControlMask|Mod4Mask,          XK_Right,      moveresize,             {.v = "25x 0y 0w 0h" } },
	{  ControlMask|Mod4Mask,          XK_Left,       moveresize,             {.v = "-25x 0y 0w 0h" } },

//	{ MODKEY|Mod4Mask|ShiftMask,    XK_a,       moveresize,             {.v = "0x 0y 0w 25h" } },
//	{ MODKEY|Mod4Mask|ShiftMask,    XK_s,         moveresize,             {.v = "0x 0y 0w -25h" } },
	...
	#if MOVESTACK_PATCH
	{ Mod4Mask,	  		        XK_Left,       movestack,              {.i = +1 } },
	{ Mod4Mask,           			XK_Right,      movestack,              {.i = -1 } },
// 	Vim binding for swapping windows	
	{ Mod4Mask,	  		        XK_h, 	       movestack,              {.i = +1 } },
	{ Mod4Mask,           			XK_l, 	       movestack,              {.i = -1 } },
...
//	{ MODKEY|ControlMask,          XK_Down,     zoom,                   {0} },
	#if VANITYGAPS_PATCH
...
//	{ MODKEY,                       XK_Tab,        view,                   {0} },
	#if SHIFTTAG_PATCH
	{ MODKEY|ControlMask,           XK_BackSpace,  shifttag,               { .i = -1 } }, // note keybinding conflict with focusadjacenttag tagtoleft
	{ MODKEY|ShiftMask,             XK_comma,      shifttag,               { .i = -1 } }, // note keybinding conflict with focusadjacenttag tagtoleft

	{ MODKEY|ControlMask,           XK_Return,     shifttag,               { .i = +1 } }, // note keybinding conflict with focusadjacenttag tagtoright
	...
	{ Mod4Mask,              	XK_Left,       shiftviewclients,       { .i = -1 } },
	{ Mod4Mask,              	XK_Right,      shiftviewclients,       { .i = +1 } },
...
// jcs ergonomic set back to tiling 
	//{ MODKEY | ControlMask,         XK_k,          setlayout,              {.v = &layouts[0]} },
	//{ MODKEY | Mod4Mask,            XK_Down,       setlayout,              {.v = &layouts[0]} },

	{ MODKEY,                       XK_f,          setlayout,              {.v = &layouts[1]} },
	{ MODKEY|ControlMask,           XK_Up, 	       setlayout,              {.v = &layouts[2]} },
	{ MODKEY|ControlMask,           XK_j,          setlayout,              {.v = &layouts[2]} },
	#if COLUMNS_LAYOUT
	...
	#endif // FLEXTILE_DELUXE_LAYOUT
	// uncommedted by justin
//	{ MODKEY,                       XK_space,      setlayout,              {0} },
	{ MODKEY,             			XK_f,      	   togglefloating,         {0} },
	#if MAXIMIZE_PATCH
	{ MODKEY|ControlMask|ShiftMask, XK_h,          togglehorizontalmax,    {0} },
	{ MODKEY|ControlMask|ShiftMask, XK_l,          togglehorizontalmax,    {0} },
//  *Resize vertically but snapped
//	{ MODKEY|ShiftMask, 			XK_Up,         toggleverticalmax,      {0} },
	{ MODKEY|ControlMask|ShiftMask, XK_k,          toggleverticalmax,      {0} },
	//{ MODKEY|ControlMask,           XK_Up,         togglemax,              {0} },
	...
	{ MODKEY|ControlMask,           XK_k,          unfloatvisible,         {.v = &layouts[0]} },
	{ MODKEY|ControlMask,           XK_Down,       unfloatvisible,         {.v = &layouts[0]} },
...
// 	Sends client to external monitor if active
...
//justin floating window snapping 	
	{ MODKEY | Mod4Mask,                    XK_Left,       explace,                {.ui = EX_W  }}, /* XK_KP_Left,*/
	{ MODKEY | Mod4Mask,                    XK_Right,      explace,                {.ui = EX_E  }},   /* XK_KP_Right, */
	{ MODKEY | Mod4Mask,                    XK_h,       explace,                {.ui = EX_W  }}, /* XK_KP_Left,  */
	{ MODKEY | Mod4Mask,                    XK_l,      explace,                {.ui = EX_E  }},   /* XK_KP_Right, */
//end 
//	{ Mod4Mask,           XK_h,         explace,                {.ui = EX_W  }},   /* XK_KP_Left,  */
//	{ Mod4Mask,           XK_l,         explace,                {.ui = EX_E  }},   /* XK_KP_Right, */
	...
	// jcs overload 															      //
	{ MODKEY|Mod4Mask|ShiftMask,    XK_j,       exresize,               {.v = (int []){   0,  25 }}},  /* XK_KP_Up,    */
	{ MODKEY|Mod4Mask|ShiftMask,    XK_Up,       exresize,               {.v = (int []){   0,  25 }}},  /* XK_KP_Up,    */

	{ MODKEY|Mod4Mask|ShiftMask,	XK_k,       exresize,               {.v = (int []){   0, -25 }}},  /* XK_KP_Down,  */ 
	{ MODKEY|Mod4Mask|ShiftMask,	XK_Down,    exresize,               {.v = (int []){   0, -25 }}},  /* XK_KP_Down,  */ 

	{ MODKEY|Mod4Mask|ShiftMask,   XK_h,      exresize,               {.v = (int []){  25,   0 }}},  /* XK_KP_Right, */
	{ MODKEY|Mod4Mask|ShiftMask,   XK_l,     exresize,               {.v = (int []){ -25,   0 }}},  /* XK_KP_Left,  */
	
	{ MODKEY|Mod4Mask|ShiftMask,   XK_Left,      exresize,               {.v = (int []){  25,   0 }}},  /* XK_KP_Right, */

	{ MODKEY|Mod4Mask|ShiftMask,   XK_Right,     exresize,               {.v = (int []){ -25,   0 }}},  /* XK_KP_Left,  */
// end jcs overload	
	...
	{ MODKEY|ControlMask,           XK_p,       toggleverticalexpand,   {.i = +1} },  /* XK_KP_Up,    */
//justin floating window snapping 	
{ MODKEY | Mod4Mask,                    XK_Left,       toggleverticalexpand,   {.i =  0} },  /* XK_KP_End,   */
{ MODKEY | Mod4Mask,                    XK_Right,      toggleverticalexpand,   {.i =  0} },  /* XK_KP_End,   */

//justin  vim bindings 
{ MODKEY | Mod4Mask,                    XK_h,       toggleverticalexpand,   {.i =  0} },  /* XK_KP_End,   */
{ MODKEY | Mod4Mask,                    XK_l,       toggleverticalexpand,   {.i =  0} },  /* XK_KP_End,   */

//{ Mod4Mask,                     XK_h,       toggleverticalexpand,   {.i =  0} },  /* XK_KP_End,   */
//{ Mod4Mask,                     XK_l,      toggleverticalexpand,   {.i =  0} },  /* XK_KP_End,   */
...
static Command commands[] = {
	/* modifier (4 g)                          keysyms (4 keys)                                function         argument */
